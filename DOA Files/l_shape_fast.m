...
for i=1:2
    cmdl=[hex2dec('7E'),00,10, 01, 00, 00, 00 , 00, 78, 69, 88, 149, 70,-220];
    cmdr=[hex2dec('7E'),00,10, 01, 00, 00, 00 , 00, 78, 69, 88, 150, 70,-221];
    fwrite(s,cmdsafe)
    fwrite(s,cmdm)
    fwrite(s,cmdl)
    fwrite(s,cmdr)
    ...
    cmdl=[hex2dec('7E'),00,10, 01, 00, 00, 00 , 00, 78, 69, 88, 149, 109,-220];
    cmdr=[hex2dec('7E'),00,10, 01, 00, 00, 00 , 00, 78, 69, 88, 150, 109,-221];
